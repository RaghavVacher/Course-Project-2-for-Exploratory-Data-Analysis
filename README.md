...
This is a collection of code written for the second course project of the Exploratory Data Analysis on Coursera

To provide context, here were the requirement of the projects:
...
Of the four types of sources indicated by thetype (point, nonpoint, onroad, nonroad) variable, which of these four sources have seen decreases in emissions from 1999–2008 for Baltimore City? Which have seen increases in emissions from 1999–2008? Use the ggplot2 plotting system to make a plot answer this question.
